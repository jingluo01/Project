...
### 📝 注册白名单 (Registration Whitelist)

注册时会校验学校官方库中的学号/工号与姓名，数据来源为 `school_official` 数据库中的 `school_members` 表；只有信息匹配的人员才可完成注册。以下为演示环境中的注册白名单示例：

| 身份 | 账号 (user_no) | 姓名 | 说明 |
| `20230001` | 张三 | 学生 | 计算机科学与技术学院 |
| `20230002` | 李四 | 学生 | 人工智能学院 |
| `20230003` | 王小五 | 学生 | 机械工程学院 |
| `20230101` | 王维 | 学生 | 软件工程系 |
| `20230205` | 刘星 | 学生 | 材料科学与工程 |
| `20230321` | 陈默默 | 学生 | 公共管理学院 |
| `20230415` | 林黛 | 学生 | 外国语学院 |
| `T1001` | 赵老师 | 教职工 | 自动化学院 |
| `T1002` | 钱教授 | 教职工 | 管理学院 |
| `T1003` | 孙主任 | 教职工 | 后勤保障部 |
| `T1102` | 高博 | 教职工 | 土木工程学院 |
